...
namespace TravelMate.Controllers
{
    public class UserloginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Passwordd,UserId,RoleId")] Userlogin userlogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Username,Passwordd,UserId,RoleId")] Userlogin userlogin)
        {
            if (id != userlogin.Id)
            {
                return NotFound();
