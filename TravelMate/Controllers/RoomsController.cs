...
namespace TravelMate.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomId,Roomnumber,Roomtype,Pricepernight,Isavailable,HotelId")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("RoomId,Roomnumber,Roomtype,Pricepernight,Isavailable,HotelId")] Room room)
        {
            if (id != room.RoomId)
            {
                return NotFound();
