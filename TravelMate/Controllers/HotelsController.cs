...
namespace TravelMate.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HotelId,Hotelname,ImageFile")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("HotelId,Hotelname,ImageFile")] Hotel hotel)
        {
            if (id != hotel.HotelId)
            {
                return NotFound();
